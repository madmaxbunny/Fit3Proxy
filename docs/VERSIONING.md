...
- **앱 versionName:** `MAJOR.MINOR.PATCH[-suffix]` (예: `0.6.3-docs`)
- **앱 versionCode:** 정수, 매 스토어/사이드로드 배포마다 +1 (현재 `15`)
- **Git 태그:** `vMAJOR.MINOR.PATCH` (예: `v0.6.3`) — 소스의 `versionName`과 맞출 것
...
{
  "versionCode": 15,
  "versionName": "0.6.3-docs",
  "apk": "Fit3Proxy-0.6.3-docs-debug.apk"
}
```
...
| versionCode | 15 |
| 태그 | v0.6.3 |
| 릴리스 | https://github.com/madmaxbunny/Fit3Proxy/releases/tag/v0.6.3 |
